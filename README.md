...
I used Pandas library to segregate the tables from the main csv file using generate_tables.py. I used Mysql for the storinng these tables and using load_csv_mysql.py I created a database and tables.
